...
BREAD_DATA = {
    "base": [
        { 
            ...
            "image": 'static/bakery/img/base/sourdough.jpg' # <--- แก้ไข
        },
        { 
            "id": 'shokupan', 
            "name": 'Shokupan (Loaf)', 
    ...
    "mixins": [
        { "id": 'none', "name": 'ไม่ใส่', "price": 0, "icon": 'fa-circle', "color": 'text-red-500', "image": '/static/bakery/img/icon/none.png' },
        { "id": 'wholewheat', "name": 'Whole Wheat', "price": 15, "icon": 'fa-circle', "color": 'text-red-500', "image": '/static/bakery/img/icon/wholewheat.png' },
    ...
    #    { "id": 'chocolate', "name": 'ดาร์กช็อกโกแลต', "price": 35, "icon": 'fa-cookie', "color": 'text-gray-700', "image": '/static/bakery/img/icon/chocolate.png' },
        { "id": 'raisin', "name": 'ลูกเกด', "price": 25, "icon": 'fa-cookie-bite', "color": 'text-yellow-600', "image": '/static/bakery/img/icon/raisin.png' },
        { "id": 'pumpkin', "name": 'เมล็ดฟักทอง', "price": 25, "icon": 'fa-seedling', "color": 'text-green-600', "image": '/static/bakery/img/icon/pumpkin.png' },
        { "id": 'sunflower', "name": 'เมล็ดทานตะวัน', "price": 25, "icon": 'fa-seedling', "color": 'text-green-600', "image": '/static/bakery/img/icon/sunflower.png' },
        { "id": 'flaxseed', "name": 'เมล็ดแฟลกซ์', "price": 25, "icon": 'fa-seedling', "color": 'text-green-600', "image": '/static/bakery/img/icon/flaxseed.png' },
        { "id": 'sesame', "name": 'งาดำ/ขาว', "price": 25, "icon": 'fa-seedling', "color": 'text-green-600', "image": '/static/bakery/img/icon/sesame.png' },
        { "id": 'quinoa', "name": 'ควินัว', "price": 25, "icon": 'fa-seedling', "color": 'text-green-600', "image": '/static/bakery/img/icon/quinoa.png' },
    ],

    "toppings": [
        { "id": 'none', "name": 'ไม่ใส่', "price": 0, "icon": 'fa-ban' },
        { "id": 'pumpkin', "name": 'เมล็ดฟักทอง', "price": 10, "icon": 'fa-ellipsis', "color": 'text-gray-800' },
        { "id": 'sunflower', "name": 'เมล็ดทานตะวัน', "price": 10, "icon": 'fa-ellipsis', "color": 'text-gray-800' },
    #    { "id": 'flaxseed', "name": 'เมล็ดแฟลกซ์', "price": 10, "icon": 'fa-ellipsis', "color": 'text-gray-800' },
        { "id": 'sesame', "name": 'งาขาว/ดำ', "price": 10, "icon": 'fa-ellipsis', "color": 'text-gray-800' },
    #    { "id": 'quinoa', "name": 'ควินัว', "price": 10, "icon": 'fa-ellipsis', "color": 'text-gray-800' },
